...
const ListItem = tw.li`my-[12px] mx-4 hocus:text-[rgba(0,0,0,1)] font-semibold tracking-wide transition duration-300
border-b-2 border-transparent`;
const ListSelected = tw.li`py-[8px] px-4 m-1 text-white bg-primary-400 font-semibold tracking-wide transition duration-300
