...
const Container = tw(
  motion.div
)`w-full h-[60px] fixed top-0 right-0 left-0 z-[99] inset-0 bg-white bg-opacity-0 backdrop-filter backdrop-blur-md flex flex-col items-center justify-around px-[24px] font-bold text-[13px] tracking-[0.0200rem]`;
