...
const Image = tw.img`max-w-full sm:mt-8 md:mt-0 sm:w-56 lg:w-96 rounded-t sm:rounded-t-lg md:rounded-md relative z-20 sm:left-image md:left-0`;
...
`;
const Testimonial = tw.div`max-w-full rounded-md absolute bottom-0 sm:invisible md:visible sm:translate-y-48 lg:translate-y-16 inset-x-0 z-20 px-8 py-6 sm:px-4 lg:px-10 
...
const Nameplate = tw.div`max-w-xs rounded-md sm:visible md:invisible text-center bg-primary-900 text-gray-100 text-2xl z-20 absolute w-64 left-nameplate`;
          ...
          <Row>
            <ImageColumn>
              <ImageContainer>
                ...
                <Testimonial>
                  <TextRow>
                    <Quote>{fastDesc.name[0]}</Quote> {fastDesc.name[1]}
                  </TextRow>
                  <TextRow>
                    <Quote>{fastDesc.likes[0]}</Quote> {fastDesc.likes[1]}
                  </TextRow>
                  <TextRow>
                    <Quote>{fastDesc.dislikes[0]}</Quote> {fastDesc.dislikes[1]}
                  </TextRow>
                  <TextRow>
                    <Quote>{fastDesc.food[0]}</Quote> {fastDesc.food[1]}
                  </TextRow>
                </Testimonial>
